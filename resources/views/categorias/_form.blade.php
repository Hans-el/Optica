...
<div class="grid grid-cols-1 gap-5">
    ...
    <div>
        ...
        <textarea name="descripcion" rows="3"
                  class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500">{{ old('descripcion', $categoria->descripcion ?? '') }}</textarea>
    </div>
    ...
    <div class="flex items-center gap-2">
        ...
        <label for="activo" class="text-sm text-gray-700">Categoría activa</label>
    </div>
</div>