    ...
    <div class="flex items-start justify-between mb-6">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">
                <a href="{{ url('/') }}" class="hover:underline">Inicio</a> / Categorías
            </p>
        </div>
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-5 py-3">
                            <div class="flex items-center justify-end gap-2">
                                <a href="{{ route('categorias.show', $item) }}" class="p-2 rounded-lg border border-gray-200 hover:bg-gray-100" aria-label="Ver">
                                ...
                                <a href="{{ route('categorias.edit', $item) }}" class="p-2 rounded-lg border border-gray-200 hover:bg-gray-100" aria-label="Editar">
                                ...
                                <form action="{{ route('categorias.destroy', $item) }}" method="POST" onsubmit="return confirm('¿Eliminar esta categoria?');">
                                    @csrf
                                    @method('DELETE')
                ...
                @empty
                    <tr>
                        <td colspan="5" class="px-5 py-10 text-center text-gray-400">
                            No hay categorias registradas todavía.
                            <a href="{{ route('categorias.create') }}" class="text-emerald-700 font-medium hover:underline">Crea la primera</a>.
                        </td>
                    </tr>
                @endforelse
            </tbody>
