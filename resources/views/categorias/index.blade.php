...
@section("content")
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-3xl font-bold text-gray-900 capitalize">categorias</h1>
    ...
    <div class="bg-white rounded-xl border border-gray-100 p-8 text-center text-gray-400">
        Vista en construcción — próximamente el listado de categorias con el mismo diseño que "Lentes".
    </div>
@endsection