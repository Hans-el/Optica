...
@section("content")
    ...
    <div class="mb-6">
        ...
        <p class="text-sm text-gray-500 mt-1">
            <a href="{{ route('categorias.index') }}" class="hover:underline">Categorías</a> / Nueva
        </p>
    </div>

    <form action="{{ route('categorias.store') }}" method="POST" class="bg-white rounded-xl border border-gray-100 p-6 max-w-lg">
        @csrf
